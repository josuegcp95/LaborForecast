            ...
            Section("Acknowledgements") {
                VStack(alignment: .leading, spacing: 6) {
                    Text("Andrej Karpathy")
                        .font(.subheadline)
                        .fontWeight(.semibold)
                    Text("AI exposure scoring concept and pipeline. Andrej designed the 0–10 scoring rubric, scraped all 342 BLS occupations, and built the original LLM scoring pipeline that this app's data is built upon. This app includes 341 of those occupations.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
//                    Link("@Andrej on X", destination: URL(string: "https://x.com/karpathy")!)
//                        .font(.caption)
//                        .foregroundStyle(Color.LFGreen)
                }
                .padding(.vertical, 4)
